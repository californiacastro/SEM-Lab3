...
## $\color{purple}{\text{Creating a version-controlled R-Project with Github}}$
...
decorate("lm1") %>% 
  flair("vocabulary", color = "#FF851B") %>% 
  flair("sex", color = "#0074D9") %>% 
  flair("education", color = "#2ECC40") %>% 
  flair("sex:education", color = "#39CCCC")
...
$$
\color{#FF851B}{\text{vocabulary}} = \alpha + \beta_{1}(\color{#0074D9}{\text{sex}_{\text{Male}}}) + \beta_{2}(\color{#2ECC40}{\text{education}}) +
\beta_{3}(\color{#0074D9}{\text{sex}_{\text{Male}}} \times \color{#2ECC40}{\text{education}}) + \epsilon
$$
...
knitr::include_graphics(here("figures", "m1_simple_slope.png"))
```
...
knitr::include_graphics(here("figures", "m2_simple_slope.png"))
```
